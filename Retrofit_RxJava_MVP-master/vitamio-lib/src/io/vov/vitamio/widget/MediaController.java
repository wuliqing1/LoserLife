...
public class MediaController extends FrameLayout {
    ...
    private View.OnClickListener mScreenSizeListener = new View.OnClickListener() {
        public void onClick(View v) {
            if (mPlayer != null) {
                mPlayer.chargeScreenSize(v);
            }
        }
    };
    ...
    OnClickListener downloadListener = null;
    public void setDonwloadView(boolean show,OnClickListener listener) {
        isShowDownload = show;
    ...
    private void initControllerView(View v) {
        mDownloadButton = (ImageView) v.findViewById(getResources().getIdentifier("mediacontroller_download", "id", mContext.getPackageName()));
        if (mDownloadButton!=null){
            mDownloadButton.setVisibility(isShowDownload ? VISIBLE : INVISIBLE);
        ...
        mScreenSize = (ImageView) v.findViewById(getResources().getIdentifier("mediacontroller_screen_size", "id", mContext.getPackageName()));
        if (mScreenSize != null) {
            mScreenSize.setOnClickListener(mScreenSizeListener);
        }
